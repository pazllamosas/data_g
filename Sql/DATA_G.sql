...
CREATE PROCEDURE DATA_G.MODIFICAR_AERONAVE (@MATRICULA NVARCHAR, @MODELO NVARCHAR, @KGDISP NUMERIC(18,0), @FABRICANTE NVARCHAR (255), @IDSERV INT, @CANTBUTACAS INT, @UBICACION INT) AS
