...
GO
CREATE PROCEDURE DATA_G.GET_CLIENTE_ID(@DNI NUMERIC (18,0), @NOMBRE NVARCHAR (255), @APELLIDO NVARCHAR (255), @FECHANAC DATETIME) AS
BEGIN
	DECLARE @CLI_ID INT
...
GO
CREATE PROCEDURE DATA_G.GET_ID_ESTADO(@ESTADO NVARCHAR(255)) AS
BEGIN
...
GO
CREATE PROCEDURE DATA_G.GET_ID_FUNCIONALIDAD(@FUNCIONALIDAD VARCHAR(255)) AS
BEGIN
...
GO
CREATE PROCEDURE DATA_G.GET_ID_AERONAVE(@MATRICULA NVARCHAR(255)) AS
BEGIN
...
GO
CREATE PROCEDURE DATA_G.GET_ID_PRODUCTO(@PRODUCTO NVARCHAR(255)) AS
BEGIN
...
GO
CREATE PROCEDURE DATA_G.GET_ID_PUNTOCOMPRA(@PUNTODECOMPRA VARCHAR(255)) AS
BEGIN
...
GO
CREATE PROCEDURE DATA_G.GET_ID_RUTA(@CODIGO NUMERIC(18,0), @ORIGEN NUMERIC (18,0), @DESTINO NUMERIC (18,0), @SERVICIO INT) AS
BEGIN
	DECLARE @IDRUTA INT
