    ...
    public partial class ClientesConMasPuntosAcumuladosALaFecha : Form
    {
        ...
        private void btnConsultar_Click(object sender, EventArgs e)
        {
            if (cmbSemestre.Text == "1")
            {
                ...
                string query = " SELECT * FROM DATA_G.TOP5_CLIENTES_PUNTOS(" + "00/06/" + fecha + ")"; //ver si es query o procedure
            ...
            else if (cmbSemestre.Text == "2")
            {
                ...
                string query = " SELECT * FROM DATA_G.TOP5_CLIENTES_PUNTOS(" + "00/12/" + fecha + ")"; //ver si es query o procedure
                SqlDataReader reader = Conexion.ejecutarQuery(query);
